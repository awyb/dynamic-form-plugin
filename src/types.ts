...
export interface FieldConfig {
  ...
  /** 自定义校验规则 */
  validate?: Record<string, any> | ((value: any, formValues: Record<string, any>) => true | string)
  /** 值变化回调 */
...
/** useDynamicForm 的参数 */
export interface UseDynamicFormOptions<T extends FieldValues = Record<string, any>> {
  /** 表单 Schema 树 */
  schema: FormNode
  /** 默认值 */
  defaultValues?: T
...
/** useDynamicForm 的返回值 */
export interface UseDynamicFormReturn<T extends FieldValues = Record<string, any>> {
